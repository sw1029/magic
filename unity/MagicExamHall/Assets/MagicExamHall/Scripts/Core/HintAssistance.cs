    ...
    public static class HintAssistance
    {
        ...
        public static IReadOnlyList<string> ChecklistFor(SpellFamily family)
        {
            return family switch
            {
                ...
                SpellFamily.Water => new[] { "한 획으로 둥글게 이어 돌기", "끝점을 시작점 바로 옆에 놓기", "네 모서리가 생기지 않게 부드러운 타원/물방울 만들기" },
        ...
        private static string ActionHintFor(SpellFamily family)
        {
            return family switch
            {
                ...
                SpellFamily.Water => "한 획으로 부드러운 물방울이나 타원을 그리고 끝점을 시작점 가까이에 놓아 보세요.",
        ...
        private static string StrongHintFor(SpellFamily family)
        {
            return family switch
            {
                ...
                SpellFamily.Water => "물은 모서리 없는 닫힌 물방울입니다. 한 번에 둥글게 이어 그리고 끝점을 시작점 바로 옆에 놓으세요.",
